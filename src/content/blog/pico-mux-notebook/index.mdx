...
That covers most of the parts I wanted to cover in the initial design.
...
The second image shows the new Neopixel footprint. Nothing other than that had changed, but it allowed the colors to be more prominent. 
